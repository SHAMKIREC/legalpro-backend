...
/**
 * GET /telegram — для входа через Telegram Widget (когда бот открывается с параметрами в query)
 */
router.get('/telegram', async (req, res) => {
  try {
    ...
    // Проверка подписи (аналогично /telegram-login)
    ...
    console.error('GET /telegram error:', e);
